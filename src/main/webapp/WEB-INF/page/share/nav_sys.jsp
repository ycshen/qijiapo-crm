...
<div id="nav_panel" class="text-center <%=nav_panel_state%>">
	...
	<div id="nav_panel_goGroup">
		<a href="<c:url value="/"></c:url>"><span class="glyphicon glyphicon-circle-arrow-left"
			aria-hidden="true"></span> </a> <span class='title'>微服务</span>
	</div>
	<div id="nav_ext">
	...
	<div id="nav_list" class="scrollbar">
		<ul>
			...
			<li
				...
				href="<c:url value="/provider/system/list"/>" title="系统管理"><span
					class="glyphicon glyphicon-th-large" aria-hidden="true"></span>系统管理</a></li>
			<li
				<c:if test="${param.nav=='module'}"> class="current"</c:if>><a
				data-toggle="tooltip" data-placement="auto right"
				href="<c:url value="/provider/module/list"/>" title="分组管理"><span
					class="glyphicon glyphicon-folder-close" aria-hidden="true"></span>分组管理</a></li>
			<li
				<c:if test="${param.nav=='endpoint'}"> class="current"</c:if>><a
				data-toggle="tooltip" data-placement="auto right"
				href="<c:url value="/provider/endpoint/list"/>" title="接口管理"><span
					class="glyphicon glyphicon-indent-right" aria-hidden="true"></span>接口管理</a></li>
		</ul>
	</div>
