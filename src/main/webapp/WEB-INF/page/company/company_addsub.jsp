...
<body>
	...
	<form method="post" id="companyForm">
			<input type="hidden" name="parentCompanyId" value="${company.id }">
			<input type="hidden" name="parentCompanyName" value="${company.companyName }">
			<tr>
				<td style="border:0px;text-align:right;">
					<label ><span style="color:red;">*</span>企业名称：</label>
				</td>
				<td style="border:0px;">
					<input name="companyName" id="txtCompanyName" maxlength="20"
			...
			<tr>
				...
				<td style="border:0px;">
					<input name="companyAddress" id="txtCompanyAddress"  maxlength="20"
...
<script type="text/javascript" src="${ctx}/js/pages/company/company_addsub.js"></script>
</body>
</html>